...
class PromotionController{
    ...
    createPromotion = async(req:Request, res:Response) =>{
        try{
            ...
            const fetchPlan = await this.promoPlanService.findPromoPlanById(plan_type);
            ...
            const expired_by = date.toLocaleDateString();
            ...
            const debitAmount = parseFloat(amount.toString()) - parseFloat(planAmount.toString());
